...
import Repositorios.IMovimientoInventarioRepository;
import Servicios.interfaces.IMovimientoInventarioService;
...
public class MovimientoInventarioService implements IMovimientoInventarioService {
    ...
    @Override
    public MovimientoInventario_Salida cambiarTipo(MovimientoInventarioCambiarTipo movimientoInventarioCambiarTipo) {
        MovimientoInventario movimientoInventario = movimientoInventarioRepository.findById(movimientoInventarioCambiarTipo.getId().get());
        movimientoInventario.setTipo(MovimientoInventario.Status.valueOf(movimientoInventarioCambiarTipo.getTipo()));
